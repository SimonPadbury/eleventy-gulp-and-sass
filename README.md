...
**This below is what I did in preparing this project repository. But I have not included the dependencies (Eleventy, Gulp and other node modules) here.**

You can just download or clone this repo – and then work though these tutorial instructons below for adding `Eleventy`, `Gulp` and `gulp-sass`. Or you can follow along to retro-fit Gulp`, `gulp-sass` etc. to your already existing Eleventy project.
